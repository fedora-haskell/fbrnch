...
%global gittag 7d0e70dd12f0b02c7ed43e745ea82f4cb3872d9f
...
%changelog
* Fri Jul  3 2020 Jens Petersen <petersen@redhat.com> - 0.1-5.git7d0e70d
- 'scratch' build command
- 'build' options --override and --no-fail-fast

* Thu Jul  2 2020 Jens Petersen <petersen@redhat.com> - 0.1-4.gitcdeaffb
...
* Wed Jul  1 2020 Jens Petersen <petersen@redhat.com> - 0.1-2.git4612be2
